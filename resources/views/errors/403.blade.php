...
<head>
    <title>403 - ¡No deberías estar aquí!</title>
...
<div class="container404">
    <img class="image404" src="{{asset('images/403-01.png')}}"/>
</div>

<div class="containerUpps">
    <span class="textLeft404">Upps!</span>
    <span class="textRight404">Parece que no tienes los permisos necesarios <br> para estar aquí.</span>
</div>
